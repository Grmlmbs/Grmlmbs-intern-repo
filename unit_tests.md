...
&#x09;It is important because it helps you verify that your code works correctly, consistently, and safely as the project grows, without manually checking everything every time you make a change.
...
&#x09;The thing I find difficult is that figuring out what some lines does, I'm not really familiar with this and I think I still need some time to figure out this things to be able to use them properly and integrate them to my workflow properly.
